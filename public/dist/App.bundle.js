...
function loadPlaces(map) {
    var lat = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 32.47;
    var lng = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 51.78;
...
function typeAhead(search) {
    ...
    searchInput.on("input", function () {
        ...
        // If there is no result from API, reset the searchResults html to nothing!
        // ! We moved the searchResults.innerHTML to line 40
    ...
    searchInput.on("keyup", function (e) {
        ...
        if (![38, 40, 13].includes(e.keyCode)) {
            return; // Ignore it, skip it, naaaaaaah!
        }
...
var _staticmap = __webpack_require__(13);
